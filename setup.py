...
def main():
    ...
    if sys.platform.startswith('linux'):
        cmake_args.append("-DWITH_IPP=OFF"# No 3rd-party modules here, see "3rd-party" note below
import io
import os
import os.path
import sys
...
def main():
    ...
    if sys.platform.startswith('linux'):
        ...
        cmake_args.append("-DCUDA_ARCH_BIN=6.2")
        cmake_args.append("-DCUDA_ARCH_PTX=""")
        cmake_args.append("-DENABLE_FAST_MATH=ON")
        cmake_args.append("-DCUDA_FAST_MATH=ON")
        ...
        cmake_args.append("-D BUILD_PERF_TESTS=OFF ")
        cmake_args.append("-D WITH_TBB=ON")
    ...
    if OPENCV_ENABLE_NONFREE('linux'):
